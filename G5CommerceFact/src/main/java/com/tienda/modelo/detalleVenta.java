...
public class detalleVenta {
	...
	public detalleVenta(Integer codigo_detalle_venta, Integer cantidad_producto, Integer codigo_producto,
			Integer codigo_venta, Double valor_total, Double valor_venta, Double valoriva) {
		super();
